...
CarStatePin CarState::pins[] = {
    ...
    // esp32 GIO pins
    {DO_TCK_GPIO13,               OUTPUT,         0, 0, false, 0l, DO_TCK_GPIO13_name,               NULL,                           false,   0},
    ...
    {DO_BreakLight_GPIO27,        OUTPUT,         0, 0, false, 0l, DO_BreakLight_GPIO27_name,        NULL,                           false,   0},
    ...
    {DI_Button_Confirm_GPIO21,    INPUT_PULLUP,   0, 0, false, 0l, DI_Button_Confirm_GPIO21_name,    buttonConfirmDriverInfoHandler, false,  50}
};
