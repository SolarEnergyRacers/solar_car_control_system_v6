...
start('code', '/home/ksc/work/ser4/solar_car_control_system_v6/AC/SER_v6_AC.code-workspace',
      10, 10, width//2-16, int(height*.9))
time.sleep(1)
start('code', '/home/ksc/work/ser4/solar_car_control_system_v6/DC/SER6_v6_DC.code-workspace',
