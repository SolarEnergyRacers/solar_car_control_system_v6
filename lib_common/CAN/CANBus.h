...
class CANBus : public AbstractTask {
   ...
   public:
    ...
    // Cooldown before attempting a full CAN re-init again (ms)
    // Used to avoid rapid re-inits; sensible default 8 seconds.
    ...
    CANPacket writePacket(uint16_t adr, uint16_t data_u16_0, uint16_t data_u16_1, uint16_t data_u16_2, uint16_t data_u16_3,
                          bool force = false);
    CANPacket writePacket(uint16_t adr, uint16_t data_u16_0, uint8_t data_u8_2, uint8_t data_u8_3, uint8_t data_u8_4, uint8_t data_u8_5,
                          bool data_b_48, bool data_b_49, bool force = false);
