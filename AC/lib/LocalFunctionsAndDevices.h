...
#define SERIAL_RADIO_ON true     // additionally write to Serial2, the radio console
#define SERIAL_RADIO_CMD_ON false // additionally read from Serial2, the radio console
